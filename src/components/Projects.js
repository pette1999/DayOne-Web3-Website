                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  ...
                  <Tab.Content id="slideInUp" className={isVisible ? "animate__animated animate__slideInUp" : ""}>
                    <Tab.Pane eventKey="first">
                      ...
                      <h5 className="eventtitle">Mave: Game Changer to the Web 3 World<br></br>What to expect after Bitcoin and Ethereum?</h5>
                      ...
                      <p><b>Speakers:</b> <br></br>David - Founding Engineer@Aptos Labs<br></br>Neil - Head of Strategy@Aptos Labs</p>
                      <p><b>🚀 Join the event to get:</b> <br></br>🎁 Amazing swags <br></br>🥪 Free lunch Provided <br></br>🧙‍♀️ Chances to win $100 Amazon gift Card</p>
                      <p>
                        <a className="resp-sharing-button__link" href="http://twitter.com/share?text=🔥Aptos is coming to Stanford THIS FRIDAY 10/14 - What to expect after Bitcoin and Ethereum🚀@move_dayone&url=https://freeimage.host/i/Z5jQyu&hashtags=stanford,dayone,aptos,blockchain" target="_blank" rel="noreferrer" aria-label="Share on Twitter">
